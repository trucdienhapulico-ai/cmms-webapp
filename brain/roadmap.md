...
- [ ] **Mobile-friendly UI**: Tối ưu Dashboard, Assets, Work Orders cho kỹ thuật viên hiện trường (Issue #9).
- [x] **DevOps**: Setup Hosting (Stable & Test environments) với Docker Compose.
- [ ] **QR Code & Checklist Integration**: Scan mã thiết bị để xem hồ sơ và thực hiện checklist số (Issue #8).
