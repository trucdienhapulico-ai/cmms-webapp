...
- [ ] **Asset Tree Hierarchy**: Phân cấp Tòa nhà -> Hệ thống M&E -> Thiết bị (theo Tab 3.4.1).
- [ ] **Mobile-friendly UI**: Tối ưu Dashboard, Assets, Work Orders cho kỹ thuật viên hiện trường.
- [ ] **QR Code Integration**: Scan mã thiết bị để xem hồ sơ và tạo WO nhanh (Tab 4.10).
- [ ] **Basic Reporting**: Xuất danh sách WO, Assets ra Excel.
- [ ] **DevOps**: Setup Hosting (Stable & Test environments) với Docker Compose.
...
- [ ] **Tenant Portal**: Trang báo cáo sự cố đơn giản cho cư dân/khách hàng (Tab 4.11).
- [ ] **Notifications**: Push/Email thông báo khi có WO mới, quá hạn.
